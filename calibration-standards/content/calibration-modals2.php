<div id="makeItNowDimmer2">
    <div id="modalCenter2">
        <div id="makeItNowModal2">
            <div id="modalHeader2">
            ...
            <form action="/single-solution/solution.php">
                ...
                <br>
                <input type="hidden" name="passTo" value="calibration2">
...
$(function(){
    ...
    $(".closeModal2").click(function(){
       $("#makeItNowDimmer2").css("display","none");
    });
    
    //Show modal when user clicks saved solutions button
    $("#makeItNowButton2").click(function(){
        $("#makeItNowDimmer2").css("display","inline");
    });
    ...
    function liquidExpander(){
       ...
       if($("#singleSelect2").val() == 'liquid'){
           //Show the liquid div
           $("#liquidDiv2").css("display","inline");
           //Hide the go button
           $("#singleButton2").css("display","none");
       }
        else{
            //Hide the liquid div
            $("#liquidDiv2").css("display","none");
            //Show the go button
           $("#singleButton2").css("display","inline");
        } 
    }
