...
<div class="container" id="solutionForm">
    <div class="row">
        ...
        <div class="col-md-4 hidden-sm hidden-xs"><p class="regText">Enter a name for your analyte</p></div>
        <div class="col-md-4 hidden-sm hidden-xs"><p class="regText">Enter the analyte's weight (g)</p></div>
    </div>

    <div class="row">
        <div class="col-md-4 col-sm-12"><input id="solvent_formula" name="solvent_formula" type="text" placeholder="Solvent Name"></div>
    ...
    <div class="row">
        <div class="col-md-4 col-sm-12"><p class="regText">Enter the molarity of your analyte (M)</p></div>
