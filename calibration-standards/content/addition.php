...
<div id="divContainer">
	...
	<div class="row">
		...
		<div class="col-md-4 col-sm-12"><input name="total_volume_standards" id="total_volume_standards" type="text" placeholder="Total volume of calibration standard flasks"></div>
	</div>
